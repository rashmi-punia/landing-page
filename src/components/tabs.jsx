...
<div className='md:flex  space-'>
      <div className=' md:w-1/3'  onClick={() => toggleTab(1)} >
        <div className='m-3 py-3'>
            <h1 className={toggleState===1 ? 'text-xl font-riot capitalize text-orange-400 ':'text-xl font-riot capitalize text-slate-400 text-opacity-55'}>1. post your job</h1>
            <p className={toggleState===1 ? 'text-slate-300' : 'text-opacity-45 text-slate-500'}>
...
Extend the Transform Configuration: In your tailwind.config.js file, you can extend the transform property with your custom values. Here's an example:  
      ...
      <div  className='md:w-1/3 ' onClick={() => toggleTab(2)}>
        <div className='m-3 py-3'>
            <h1 className={toggleState===2 ? 'text-xl font-riot capitalize text-orange-400 ':'text-xl font-riot capitalize  text-slate-400 text-opacity-55'}>1. post your job</h1>
            <p className={toggleState===2 ? 'text-slate-300' : 'text-opacity-45 text-slate-500 '}>
            Tell us more about whom you are looking for. 
            </p>
        </div>
        <div className ={toggleState===2 ? 'm-3 block' : 'hidden'}>
            <p className='text-slate-300'>
            Create a Custom Configuration File: First, create a tailwind.config.js file in your project's root directory if you haven't already done so.

Extend the Transform Confyour custom values. Here's an example:  
            </p>
        </div>
      </div>
      ...
      <div  className='md:w-1/3'  onClick={() => toggleTab(3)}>
        <div className='m-3 py-3' >
            <h1 className={toggleState===3 ? 'text-xl font-riot capitalize  text-orange-400':'text-xl font-riot capitalize text-slate-400 text-opacity-55'} >1. post your job</h1>
            <p className={toggleState===3 ? 'text-slate-300' : 'text-slate-500 text-opacity-45'}>
            Tell us more about whom you are looking for. 
            </p>
        </div>
        <div className={toggleState===3 ? 'm-3 block' : 'hidden'}>
            <p className='text-slate-300'>
            Create a Custom Configuration File: First, create a tailwind.config.js file in your project's root directory if you haven't already done so.
